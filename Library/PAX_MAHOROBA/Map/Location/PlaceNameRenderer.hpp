...
#ifndef PAX_MAHOROBA_PLACE_NAME_RENDERER_HPP
#define PAX_MAHOROBA_PLACE_NAME_RENDERER_HPP
...
namespace paxs {
	...
	/// @brief 地名の描画を担当するクラス (Presentation Layer)
	class PlaceNameRenderer {
	public:
		PlaceNameRenderer() = default;
...
#endif // !PAX_MAHOROBA_PLACE_NAME_RENDERER_HPP
