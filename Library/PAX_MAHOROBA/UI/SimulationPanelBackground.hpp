...
#ifndef PAX_MAHOROBA_UI_SIMULATION_PANEL_BACKGROUND_HPP
#define PAX_MAHOROBA_UI_SIMULATION_PANEL_BACKGROUND_HPP
...
namespace paxs {
    ...
    /// @brief シミュレーションパネルの背景
    /// @brief Simulation panel background
    class SimulationPanelBackground : public IWidget {
    public:
        SimulationPanelBackground() = default;
        ...
        const char* getName() const override {
            return "SimulationPanelBackground";
        }
...
#endif // !PAX_MAHOROBA_UI_SIMULATION_PANEL_BACKGROUND_HPP
