...
namespace paxs {
    ...
    struct UILayout {
        ...
        const int feature_detail_panel_x = debug_info_panel_x + debug_info_panel_width + 10; // debug_info_panel_x + width + margin
        const int feature_detail_panel_width = 420; // テキスト幅 + パディング（長い文字列に対応）
