...
namespace paxg {
    ...
    private:
        ...
        static paxs::Vector2<float> calculateCatmullRom(const paxs::Vector2<float>& p0, const paxs::Vector2<float>& p1, const paxs::Vector2<float>& p2, const paxs::Vector2<float>& p3, float t) {
            float t2 = t * t;
            float t3 = t2 * t;
