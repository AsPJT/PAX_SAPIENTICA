...
/*##########################################################################################
	⚠️ 注意：このソースファイルは試作のプログラムが数多く存在します。
	そのため可読性が低く、バグも数多くありますので実行は自己責任でお願いいたします。
##########################################################################################*/
...
void Main() {
	...
	const s3d::Texture texture_tl{ U"./../../../Image/TitleLogo.svg" };
...
, s3d::Palette::Black);
		...
		pin_font(map_license_name).draw(s3d::Arg::topLeft = s3d::Vec2(10, 10), s3d::Palette::Black);
