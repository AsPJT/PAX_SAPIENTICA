...
int main() {
	...
	for (int y = 0; y < max_xy; ++y) {
		for (int x = 0; x < max_xy; ++x) {
			output(
				"../../../Data/Map/XYZTile/ColorCodingByProvincesOfJapan/Image/Color/1868/"
				+ std::to_string(z)
				+ "/ColorCodingByProvincesOfJapanWithLakes_"
				+ std::to_string(z)
				+ "_" + std::to_string(x) + "_" + std::to_string(y) + ".png"
				,
				"../../../Data/Map/XYZTile/ColorCodingByProvincesOfJapan/Data/Color/1868/"
				+ std::to_string(z)
				+ "/ryoseikoku_"
				+ std::to_string(z)
