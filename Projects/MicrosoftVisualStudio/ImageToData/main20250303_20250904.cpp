...
namespace xyz_tiles_conv {
    ...
    //const std::string output = path + "Data/XYZTiles/Test20250518/zxy_{z}_{x}_{y}";
    const std::string output = path + "Data/XYZTiles/Test20250822/zxy_{z}_{x}_{y}";
...
int main() {
    ...
    //    /*z*/ 10,/*min_x*/ 976,/*min_y*/ 608,/*len_x*/ 48,/*len_y*/ 64,
    ...
    std::vector<xyz_tiles_conv::XYZTilesConv> conv_data_list;
    conv_data_list.emplace_back(
        /*z*/ 10,/*min_x*/ 908,/*min_y*/ 326,/*len_x*/ 20,/*len_y*/ 59,
        /*std::string*/ path + "Data/Map/XYZTile/Union/ColorCodingByProvincesOfJapan/zxy5_hs2_{z}_{min_x}_{min_y}_{len_x}_{len_y}.png"
    );
