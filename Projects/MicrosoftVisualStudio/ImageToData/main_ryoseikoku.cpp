...
int main() {
    ...
    for (int y = 326; y < 448 + 1; ++y) {
        for (int x = 853; x < 973 + 1; ++x) {
            output(
                "../../../Data/XYZTiles/Ryoseikoku_20240114_Image/1868/10/zxy_10_"
                + std::to_string(x) + "_" + std::to_string(y) + ".png"
                ,
                "../../../Data/XYZTiles/Ryoseikoku_20240114_TSV/1868/10/zxy_10_"
                + std::to_string(x) + "_" + std::to_string(y) + ".tsv"
            );
        }
    }
