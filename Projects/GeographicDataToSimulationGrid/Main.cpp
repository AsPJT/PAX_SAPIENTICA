...
#ifdef RiversAndLakesConvert

#include <RiversAndLakesConverter.hpp>

int main(){
    std::unique_ptr<paxs::RiversAndLakesConverter> rivers_and_lakes_converter(new(std::nothrow) paxs::RiversAndLakesConverter);
    if(rivers_and_lakes_converter->init()) rivers_and_lakes_converter->convert();
}
